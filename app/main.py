...
app = FastAPI(
    ...
    openapi_tags=[
        ...
        {"name": "agent-config", "description": "AI agent configuration (system prompt, greeting, etc.)"},
        ...
        {"name": "government-dashboard", "description": "Government operational summary and compliance"},
