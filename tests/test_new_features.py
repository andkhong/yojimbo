...
@pytest.mark.asyncio
async def test_operating_hours_overnight_window_allows_next_day_start_time():
    """Overnight windows allow appointments that start after midnight next day."""
    from app.services.appointment_engine import check_operating_hours
    ...
    start = datetime(2026, 2, 24, 1, 0)  # Tuesday 1:00am (Monday spillover)
