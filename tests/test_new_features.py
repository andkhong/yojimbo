...
@pytest.mark.asyncio
async def test_security_headers_csp_disables_object_embeds_and_limits_forms(client):
    """CSP should block plugin/object embeds and constrain form submissions."""
    resp = await client.get("/api/health")
    csp = resp.headers.get("content-security-policy", "")
