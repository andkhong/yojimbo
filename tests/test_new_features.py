...
@pytest.mark.asyncio
async def test_security_headers_csp_disallows_plain_ws_in_production(client, monkeypatch):
    """Production CSP should allow only secure websocket connections (wss:)."""
...
@pytest.mark.asyncio
async def test_security_headers_csp_allows_plain_ws_in_debug(client, monkeypatch):
    """Debug CSP stays permissive for local ws:// dev tooling."""
